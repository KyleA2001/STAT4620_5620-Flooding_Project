...
Storm surge is influenced by multiple meteorological and oceanographic factors, with wind speed, atmospheric pressure, temperature, and rainfall playing key roles. Prior studies have shown that wind speed is a primary driver of storm surge height, with pre-landfall wind speeds explaining up to 80% of surge variance.^[@R-Jordan2008;@R-Irish2014] Rising sea surface temperatures have also been linked to stronger storm systems, leading to more intense surges.^[@R-Lavender2018;@R-Grinsted2013] While heavy rainfall contributes to overall flood risk, its direct correlation with storm surge is less pronounced compared to wind and pressure effects.^[@R-Zhang2021]
