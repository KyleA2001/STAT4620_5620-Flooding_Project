...
```{=latex}
\begin{figure}[h]
  \includegraphics[width=0.4\linewidth]{../visualization/ccf_halifax.png}
...
```{=latex}
\begin{figure}[h]
  \includegraphics[width=0.4\linewidth]{../visualization/acf_halifax.png}
  \caption{Cross correlation Function (CCF) plot for Halifax considering differents variables:  storm surge vs wind speed (top), storm surge vs temperature (middle), storm surge vs rain (bottom).}
  \label{Bedford}
\end{figure}
```
...
```{=latex}
\begin{figure}[h]
  \includegraphics[width=0.2\linewidth]{../visualization/ccf_yarmouth.png}
