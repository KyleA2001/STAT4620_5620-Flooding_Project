...
Nova Scotia, with its extensive coastline along the Atlantic Ocean, is particularly susceptible to storm surges, which frequently exacerbate flooding events. Over the past decade, the province has experienced an increase in extreme weather conditions, including heavy rainfall and strong winds, resulting in catastrophic floods that have damaged infrastructure, displaced communities, and disrupted ecosystems [Childs, M. (2017)]. As climate change intensifies these weather patterns, understanding the climatic drivers of storm surges is crucial for improving flood risk management [Simonović, S. P. (2012)].

Storm surge is influenced by multiple meteorological and oceanographic factors, the main factor is wind speed but others have been identified like atmospheric pressure, temperature, and rainfall playing key roles.^[Resio, D. T., & Westerink, J. J., 2008] Prior studies have shown that wind speed is a main driver of storm surge height.^[] Rising sea surface temperatures have also been linked to stronger storm systems, leading to more intense surges.^[Needham, H. F., Keim, B. D., & Sathiaraj, D. (2015)] While heavy rainfall contributes to overall flood risk, its direct correlation with storm surge is less pronounced compared to wind and pressure effects.^[Fang, J. et. al, 2021]
...
Childs, M. (2017). Urban Flooding in Halifax, Nova Scotia: The extent of the issue and the approach through policy.

Fang, J., Wahl, T., Fang, J., Sun, X., Kong, F., & Liu, M. (2021). Compound flood potential from storm surge and heavy precipitation in coastal China: dependence, drivers, and impacts. Hydrology and Earth System Sciences, 25(8), 4403-4416.
...
Simonović, S. P. (2012). Floods in a changing climate: risk management (Vol. 4). Cambridge University Press.
