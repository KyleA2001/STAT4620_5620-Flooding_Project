...
png("visualization/ym_acf_res_covariates_lag.png", width=800, height=600)
par(mfrow=c(1, 1))
acf(yarmouth_var_custom$residuals, main="VAR ACF Residuals Model 3 - Yarmouth")
dev.off()
