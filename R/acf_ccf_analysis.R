...
plot(hf_ccf_surge_wind$lag[hf_ccf_surge_wind$lag>=0], hf_ccf_surge_wind$acf[hf_ccf_surge_wind$lag>=0],
     main="Halifax P1-CCF-Storm Surge vs Wind Speed", xlab="lag", ylab="CCF", type="h")
abline(h=0)
...
plot(hf_ccf_surge_temp$lag[hf_ccf_surge_temp$lag>=0], hf_ccf_surge_temp$acf[hf_ccf_surge_temp$lag>=0],
     main="Halifax P1-CCF-Storm Surge vs Temp", xlab="lag", ylab="CCF", type="h")
abline(h=0)
...
plot(hf_ccf_surge_rain$lag[hf_ccf_surge_rain$lag>=0], hf_ccf_surge_rain$acf[hf_ccf_surge_rain$lag>=0],
     main="Halifax P1-CCF-Storm Surge vs Rain", xlab="lag", ylab="CCF", type="h")
abline(h=0)
dev.off()
...
ym_acf_surge = acf(yarmouth$avg_water_surge, lag.max = 50, main="Yarmouth-ACF-Storm Surge")
